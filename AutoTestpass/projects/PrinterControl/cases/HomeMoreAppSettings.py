...
class HomeMoreAppSettings(CommonUnittest):
    ...
    def test_02_check_usage_tracking(self):
        self.Result.setDescription("1. Launch the application for the first time.",
                                   "2. Tap More Drop-Down Menu->App Settings.",
                                   "3. Check the checkbox of 'Usage Tracking'.")
        self.Result.setExpectedResult("Verify the checkbox is reflects the user selection either in Agreements during MOOBE or if user has skipped MOOBE, the dialog box that is displayed for ""Google Analytics"" and ""Supplies Shopping"" on top of home screen. "
    ...
    def test_03_uncheck_usage_tracking(self):
        ...
        self.Result.setExpectedResult("Verify the checkbox is unchecked."
    ...
    def test_04_check_usage_tracking(self):
        self.Result.setDescription("Check the checkbox of 'Usage Tracking")
        self.Result.setExpectedResult("Verify the Usage gets recorded in Google analytics.") #undone
    ...
    def test_08_check_hp_supplies_shopping(self):
        self.Result.setDescription("Check the checkbox of 'HP Sure supplies'.")
        self.Result.setExpectedResult("Verify user taps on Buy Now button in Supplies Info page (when applicable) from the printer.",#undone
    ...
    def test_09_uncheck_hp_supplies_shopping(self):
        self.Result.setDescription("Un-Check the checkbox of 'HP Sure supplies'.")
    ...
    def test_05_camera_capture_settings(self):
        self.Result.setDescription("Check the checkbox for 'Camera Capture Settings'")
        self.Result.setExpectedResult("Verify this setting is checked by default.",
