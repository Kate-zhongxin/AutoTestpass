from projects.PrinterControl.po.pages.android.Popup_contactHPonFacebookMessager import Popup_contactHPonFacebookMessager
from projects.PrinterControl.po.pages.android.Page_link_PrintQualityTools import Page_link_PrintQualityTools
from projects.PrinterControl.po.pages.android.Page_printer import Page_printer
from projects.PrinterControl.po.pages.android.Page_HelpSearchForANetworkPrinter import Page_HelpSearchForANetworkPrinter
from projects.PrinterControl.po.pages.android.Page_HelpSetUpANewPrinter import Page_HelpSetUpANewPrinter
from projects.PrinterControl.po.pages.android.Page_ConnectionIssues import Page_ConnectionIssues
from projects.PrinterControl.po.pages.android.Page_helpCenter import Page_helpCenter
from projects.PrinterControl.po.pages.android.Page_MyFile import Page_MyFile
from projects.PrinterControl.po.pages.android.Page_file import Page_file
from projects.PrinterControl.po.pages.android.Page_link_contactHPonFacebookMessager import Page_link_contactHPonFacebookMessager
from projects.PrinterControl.po.pages.android.Page_contactHPonFacebookMessager import Page_contactHPonFacebookMessager
from projects.PrinterControl.po.pages.android.Page_link_OnlineSupport import Page_link_OnlineSupport
from projects.PrinterControl.po.pages.android.Page_HowToPrint import Page_HowToPrint
from projects.PrinterControl.po.pages.android.Page_GetHPHelpAndSupport import Page_GetHPHelpAndSupport
...
class Pages_Android:
    def __init__(self, UI):
        self._UI = UI
        self.Popup_contactHPonFacebookMessager = Popup_contactHPonFacebookMessager(self._UI)
