# coding: utf-8
from projects.PrinterControl.po.models.android.Page_helpCenter_model import Page_helpCenter_model


'''helpCenter page.'''
class Page_helpCenter(Page_helpCenter_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk
        Page_helpCenter_model.__init__(self)
