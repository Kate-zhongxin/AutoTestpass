# coding: utf-8
from projects.PrinterControl.po.models.android.Page_HowToPrint_model import Page_HowToPrint_model


'''How To Print page.'''
class Page_HowToPrint(Page_HowToPrint_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk
        Page_HowToPrint_model.__init__(self)
