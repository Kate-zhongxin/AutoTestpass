# coding: utf-8
from projects.PrinterControl.po.models.android.Page_ConnectionIssues_model import Page_ConnectionIssues_model


'''Connection Issues page.'''
class Page_ConnectionIssues(Page_ConnectionIssues_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk
        Page_ConnectionIssues_model.__init__(self)
