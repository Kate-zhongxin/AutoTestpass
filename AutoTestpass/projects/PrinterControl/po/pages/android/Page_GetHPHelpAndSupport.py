# coding: utf-8
from projects.PrinterControl.po.models.android.Page_GetHPHelpAndSupport_model import Page_GetHPHelpAndSupport_model


'''GetHPHelpAndSupport page.'''
class Page_GetHPHelpAndSupport(Page_GetHPHelpAndSupport_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk
        Page_GetHPHelpAndSupport_model.__init__(self)
