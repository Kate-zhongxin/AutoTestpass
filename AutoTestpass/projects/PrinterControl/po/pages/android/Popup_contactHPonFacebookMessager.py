# coding: utf-8
from projects.PrinterControl.po.models.android.Popup_contactHPonFacebookMessager_model import Popup_contactHPonFacebookMessager_model


'''contact HP on facebook messager page.'''
class Popup_contactHPonFacebookMessager(Popup_contactHPonFacebookMessager_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk
        Popup_contactHPonFacebookMessager_model.__init__(self)
