# coding: utf-8
from projects.PrinterControl.po.models.android.Page_contactHPonFacebookMessager_model import Page_contactHPonFacebookMessager_model


'''contact HP on facebook messager page.'''
class Page_contactHPonFacebookMessager(Page_contactHPonFacebookMessager_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk
        Page_contactHPonFacebookMessager_model.__init__(self)
