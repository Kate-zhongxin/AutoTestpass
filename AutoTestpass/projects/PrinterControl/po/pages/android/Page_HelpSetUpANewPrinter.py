# coding: utf-8
from projects.PrinterControl.po.models.android.Page_HelpSetUpANewPrinter_model import Page_HelpSetUpANewPrinter_model


'''add printer page.'''
class Page_HelpSetUpANewPrinter(Page_HelpSetUpANewPrinter_model):
    def __init__(self, UI):
        self.UI = UI
        if 1 > 1:
            from fwk.object.AndroidFwk import AndroidFwk
            self.UI = AndroidFwk
        Page_HelpSetUpANewPrinter_model.__init__(self)
